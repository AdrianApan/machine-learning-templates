...
• Used to find the optimal values for the hyperparameters (params that are not learned but set, example: kernel in SVM)

• Helps us to identify which model to choose (linear [for example SVM] or non-linear for example [Kernerl SVM])
...
grid_search = GridSearchCV(estimator = classifier,
                           ...
                           scoring = 'accuracy',
                           cv = 10,
                           n_jobs = -1) # needed only if you work on a large dataset
